...
$(function() {
    ...
    var lis = [logLi, referenceLi, variableLi, screenshotLi];
    ...
    var containers = [logContainer, referenceContainer, variableContainer, screenshotContainer];
    ...
    $('#ka-upload').on('click', function() {
        $.ajax({
            ...
            error: function(response) {
                ...
                showDialog('<p>Please log in to <a target="_blank" href="https://analytics.katalon.com" class="katalon-link">Katalon Analytics (Beta)</a>.</p><p>Register your free account at <a target="_blank" href="https://www.katalon.com" class="katalon-link">https://www.katalon.com</a>.</p><p><a target="_blank" href="https://www.katalon.com/resources-center/tutorials/upload-test-execution-reports-katalon-analytics/" class="katalon-link">Learn more</a> about Katalon Analytics (Beta).</p>', true);
            }
        });
    });
});
